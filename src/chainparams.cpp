...
unsigned int pnSeed[] =
{
    ...
    0x487028bc, 0x7200c225, 0x8af0c658, 0x2e57ba1f, 0xd0098abc, 0x46a8853e, 0xcc92dc3e, 0xeb6f1955,
    0x8cce175e, 0x237281ae, 0x9d42795b, 0x4f4f0905, 0xc50151d0, 0xb1ba90c6, 0xaed7175e, 0x204de55b,
    0x4bb03245, 0x932b28bc, 0x2dcce65b, 0xe2708abc, 0x1b89b8d5, 0x12a3dc5b, 0x8a884c90, 0xa386a8b8,
    ...
    0xa9e94b5e, 0x2893484b, 0x99512705, 0xd63970ca, 0x459334f32, 0xe519a8ad, 0x92e25f5d, 0x8b84a9c1,
    ...
    0xc15ebb6a, 0x2c08c452, 0xc7fd0652, 0x7636f8ce, 0xffb38332, 0xa4c2efd5, 0xe9614018, 0xab49e557,
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04fce3456847840aaf195de8442ebecedf5b095cdbb9bc716bda9110971b28a49e0ead8564ffu1234a2209e0374782c093bb899692d524e9d6a6956e7c5ecbcd68284");
        nDefaultPort = 31008;
        nRPCPort = 22512;
        ...
        //   vMerkleTree: 4a5e1e
		const char* pszTimestamp = "The Source @OFC Coin @2016 --Year @Open Source Coin  on brink of second bailout for banks";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a679ace0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7baassd578a4c702b6bf11d5f") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1464590437;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 221102466;

        hashGenesisBlock = genesis.GetHash();
        base58Prefixes[PUBKEY_ADDRESS] = list_of(86);
        base58Prefixes[SCRIPT_ADDRESS] = list_of(15);
        base58Prefixes[SECRET_KEY] =     list_of(118);
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0xAC)(0x90)(0xCD)(0xFE);
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x40)(0xA6)(0xED)(0xCF);
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("04fc9702847ae907f195de8442ebecedf5b095cdbb9bc716bda9110971b28a49e0ead8564ff0db22209e0374782c093bb899692d524e9d6a6956e7c5ecbcd68284");
        nDefaultPort = 27183;
        nRPCPort = 21212;
        strDataDir = "OFCTes";
        bnProofOfWorkLimit = CBigNum(~uint256(0) >> 32);
        nSubsidyHalvingInterval = 10;
        ...
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1464599437;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 223140346;
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0xA8)(0xE9)(0xE1)(0x6E);
        base58Prefixes[EXT_SECRET_KEY] = list_of(0xA9)(0x55)(0x2D)(0x3F);
