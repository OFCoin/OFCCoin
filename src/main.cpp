...
#if defined(NDEBUG)
# error "OFCCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "OFCCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 7*24*60* 60; // one weeks
