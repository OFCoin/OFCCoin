...
#ifndef H_OFCCoin_SCRIPT
#define H_OFCCoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a COFCCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, OFCCoin always counted CHECKMULTISIGs
