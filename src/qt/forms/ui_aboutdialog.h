...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("Copyright &copy; 2009-YYYY The OFCCoin Core developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About OFCCoin Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>OFCCoin Core</b> version", 0));
