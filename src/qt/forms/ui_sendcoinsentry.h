...
public:
    ...
    OFCCoinAmountField *payAmount_is;
    ...
    OFCCoinAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new OFCCoinAmountField(SendCoins);
        ...
        payAmount_is = new OFCCoinAmountField(SendCoins_InsecurePaymentRequest);
        ...
        payAmount_s = new OFCCoinAmountField(SendCoins_SecurePaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the OFCCoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the OFCCoin network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
