...
public:
    ...
    OFCCoinAmountField *transactionFee;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        OFCCoinAtStartup = new QCheckBox(tabMain);
        OFCCoinAtStartup->setObjectName(QStringLiteral("OFCCoinAtStartup"));

        verticalLayout_Main->addWidget(OFCCoinAtStartup);
        ...
        transactionFee = new OFCCoinAmountField(tabWallet);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        OFCCoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start OFCCoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        OFCCoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start OFCCoin on system login", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the OFCCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the OFCCoin network through a SOCKS proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting OFCCoin.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show OFCCoin addresses in the transaction list or not.", 0));
#endif // QT_NO_TOOLTIP
