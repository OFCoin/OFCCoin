/* src/OFCCoin-config.h.  Generated from OFCCoin-config.h.in by configure.  */
/* src/OFCCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef OFCCoin_CONFIG_H

#define OFCCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@OFCCoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OFCCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OFCCoin Core 0.9.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "OFCCoin"
