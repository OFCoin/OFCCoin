...
unlocked to sign the OFCCoin-Qt.app bundle.
...
allowing somebody to distribute a OFCCoin-Qt.app or OFCCoin-qt-setup.exe with a valid
...
that the OFCCoin-qt.exe file inside the installer had not been tampered with.
