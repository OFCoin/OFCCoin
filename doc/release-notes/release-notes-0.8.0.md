OFCCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/OFCCoin/files/OFCCoin/OFCCoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OFCCoin
...
New/changed settings (command-line or OFCCoin.conf file)
--------------------------------------------------------
