OFCCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/OFCCoin/files/OFCCoin/OFCCoin-0.5.4/
...
http://gitorious.org/OFCCoin/OFCCoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix OFCCoin-Qt notifications under Growl 1.3.
Increase required age of OFCCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOFCCoin properly when installing OFCCoin-Qt over it. (Windows)
