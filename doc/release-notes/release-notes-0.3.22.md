Download URL: https://sourceforge.net/projects/OFCCoin/files/OFCCoin/OFCCoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 OFC fee schedule (users still pay 0.01 OFC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #OFCCoin00 - #OFCCoin99
