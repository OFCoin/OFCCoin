The following is a list of assets used in the OFCCoin source and their proper attribution.
...
* License: MIT
* Site: [https://OFCCointalk.org/index.php?topic=15276.0](https://OFCCointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original OFCCoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/OFCCoin.icns, src/qt/res/src/OFCCoin.svg,
	src/qt/res/src/OFCCoin.ico, src/qt/res/src/OFCCoin.png,
	src/qt/res/src/OFCCoin_testnet.png, docs/OFCCoin_logo_doxygen.png,
