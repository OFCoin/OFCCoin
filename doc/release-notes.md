OFCCoin Core version 0.9.4 is now available from:

  https://OFCCoin.org/bin/0.9.4/
...
installer (on Windows) or just copy over /Applications/OFCCoin-Qt (on Mac) or
OFCCoind/OFCCoin-qt (on Linux).
...
this update is incompatible with the OFCCoin system and could lead to consensus
forks.

OFCCoin Core released binaries from https://OFCCoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~OFCCoin/+archive/ubuntu/OFCCoin
- A third-party or self-compiled OFCCoin Core

upgrade to OFCCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/OFCCoin/).
